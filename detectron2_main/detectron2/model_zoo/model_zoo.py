...
def get_config_file(config_path):
    ...
    cfg_file = '/content/drive/MyDrive/zemi2/detectron2_main/configs/' + config_path
    # cfg_file = "/content/drive/MyDrive/zemi2/configs/COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml"
